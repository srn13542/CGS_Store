...
public class ChatServlet extends HttpServlet {
    ...
    private String getPromptForChatRoom(String chatRoomName) {
        switch (chatRoomName) {
            case "직장 시뮬레이션":
                return "직장에서 발생할 수 있는 상황에 대해 5개의 질문을 생성해주세요. 질문의 형식은 '저희 일이 꼬였는 데 어쩌죠?'와 같이 작성합니다.";
            case "소개팅 시뮬레이션":
                return "소개팅에서 발생할 수 있는 상황에 대해 5개의 질문을 생성해주세요. 질문의 형식은 '취미가 뭐예요?'와 같이 작성합니다.";
            case "대학 시뮬레이션":
                return "대학교 조별 과제에서 발생할 수 있는 상황에 대해 5개의 질문을 생성해주세요. 질문의 형식은 '저희 일정 조율 어떻게 진행할까요?'와 같이 작성합니다.";
            case "면접 시뮬레이션":
                return "면접 중 발생할 수 있는 상황에 대해 5개의 질문을 생성해주세요. 질문의 형식은 '이 회사는 왜 지원했나요?'와 같이 작성합니다.";
            default:
